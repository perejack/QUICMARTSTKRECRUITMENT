...
const SWIFTPAY_API_KEY = process.env.SWIFTPAY_API_KEY || 'quicmartstkrecruitment-key';
...
export default async (req, res) => {
  ...
  try {
    ...
    let { phoneNumber, userId, amount = 159, description = 'SurvayPay Account Activation' } = req.body;
    ...
    const externalReference = `QMSTK-${Date.now()}`;
